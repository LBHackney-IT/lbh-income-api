module Hackney
  module ServiceCharge
    class BeforeAction < Hackney::ServiceCharge::Letter
      LBA_TEMPLATE_ID = 'lib/hackney/pdf/templates/letter_before_action.erb'
      LBA_MANDATROY_FIELDS = %i[lba_expiry_date original_lease_date date_of_current_purchase_assignment]
