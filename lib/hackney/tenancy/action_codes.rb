module Hackney
  module Tenancy
    module ActionCodes
      ...
      UPDATE_COURT_OUTCOME = 'IC5'.freeze
      UPDATE_COURT_OUTCOME_UH = 'ZR6'.freeze
      ...
      FOR_UH_CRITERIA_SQL = [
        ...
        INCOME_COLLECTION_LETTER_2_UH, PRE_NOSP_WARNING_LETTER_SENT, COURT_WARNING_LETTER_SENT,
        ...
        STAGE_ONE_COMPLETE, STAGE_THREE_COMPLETE, UPDATE_COURT_OUTCOME, UPDATE_COURT_OUTCOME_UH
      ].freeze
    end
  end
end
