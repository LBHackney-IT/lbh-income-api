module Hackney
  module Tenancy
    module ActionCodes
      ...
      AGREEMENT_BROUGHT_UP_TO_DATE = 'AGR'.freeze

      INFORMAL_AGREEMENT_CONFIRMATION_LETTER = 'IAC'.freeze
      INFORMAL_AGREEMENT_BREACH_LETTER = 'BLI'.freeze

      COURT_DATE_LETTER = 'CDL'.freeze

      FORMAL_AGREEMENT_CONFIRMATION_LETTER = 'FAC'.freeze
      FORMAL_AGREEMENT_BREACH_LETTER = 'CBL'.freeze
      ...
      CODES_THAT_PAUSES_CASES = [
        ...
        INFORMAL_BREACH_LETTER_SENT, C19_COURT_ORDER_BREACHED
      ].freeze
