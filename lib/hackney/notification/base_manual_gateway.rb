module Hackney
  module Notification
    class BaseManualGateway
      attr_writer :notification_gateway, :add_action_diary_and_sync_case_usecase,
                  :document_store, :leasehold_gateway, :case_priority_store
      ...
      attr_reader :notification_gateway, :add_action_diary_and_sync_case_usecase,
                  :document_store, :leasehold_gateway, :case_priority_store
    end
  end
end
